...
int main(int argc, char** argv)
{
    ...
    //create texture
    std::shared_ptr<neu::Texture> tex1 = neu::g_resources.Get<neu::Texture>("Textures/llama.jpg");
    std::shared_ptr<neu::Texture> tex2 = neu::g_resources.Get<neu::Texture>("Textures/crate.jpg");
    tex1->Bind();
